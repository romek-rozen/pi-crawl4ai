...
| `bm25_query` | Keep only structural Markdown/text chunks relevant to this query |
| `bm25_threshold` | Minimum BM25 score for retained chunks (default `1.0`, must be ≥ 0) |
| `deep_crawl` | `bfs`, `dfs`, or `best-first` (not supported with Trafilatura or BM25) |
